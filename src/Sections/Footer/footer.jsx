        ...
        <div className='footer'>
            <div className="row">
                <div className="col first">
                    <img src='assets/birdie-logo_light.png' alt='birdie_logo' />
                    <ul className='social'>
                        <li>
                            <a href="#">
                                <svg aria-hidden="true" width="20px" height="20px" focusable="false" class="icon icon-instagram" viewBox="0 0 18 18">
                        ...
                        <li>
                            <a href="#">
                                <svg aria-hidden="true" width="42px" height="42px" focusable="false" class="icon icon-tiktok" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg">
